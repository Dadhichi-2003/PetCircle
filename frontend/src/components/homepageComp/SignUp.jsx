...
//               <select
//                 {...register("role")}
//                 className="block w-full p-2 border border-[var(--color-mid)] rounded  focus:outline-none focus:ring-2 focus:ring-gray-500"
//               >
//                 <option >User</option>
//                 <option>Expert or Trainer</option>
//               </select>
//             </div>
