  ...
  useEffect(() => {
    const fetchCommunities = async () => {
      try {
        ...
        setCommunities(res.data.communities); // Adjusted based on the response structure
        setFilteredCommunities(res.data.communities); // Adjusted based on the response structure
      } catch (err) {
        console.error(
            ...
            <TableBody>
              {filteredCommunities.map((community) => (
                <TableRow key={community._id}>
                  ...
                  <TableCell>{community.createdBy.username || "—"}</TableCell>
