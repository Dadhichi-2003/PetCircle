                                ...
                                <div className="flex items-center w-full px-4">
                                    <form className="w-full max-w-xl max-sm:hidden sm:max-w-64 md:max-w-sm lg:max-w-md xl:max-w-xl mx-auto">
                                        ...
                                        <div className="relative">
                                            ...
                                            <button
                                                type="submit"
                                                className="text-white absolute end-1 bottom-1 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-1 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                            >
                                                Search
                                            </button>
                                        </div>
                            ...
                            <ul className="space-y-2 font-medium">
                                ...
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="flex-1 ms-3 whitespace-nowrap">Adoption</span>
                                ...
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="flex-1 ms-3 whitespace-nowrap">Expert Connect</span>
                                    </a>
                                </li>
